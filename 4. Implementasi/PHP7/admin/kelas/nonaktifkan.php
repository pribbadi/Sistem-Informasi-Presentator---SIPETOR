...
<head>
    ...
    <title>
    	<?php 
		    ...
		    $kc="kelas/nonaktifkan.php?id=$idd";
		    $d=""; 
		    $kd=""; 
		    $e=""; 
		    $ke=""; 
...
<form action="nonaktifkan_proses.php?id=<?php echo $idd; ?>" class="form-horizontal row-border" method="POST">
								                        <div class="form-group">
														    ...
														    <div class="col-sm-5">
														        <input type="text"  disabled="on" name='nama' class="form-control mask" data-inputmask="'mask':'MI-9'" required="on" autofocus="on" autocomplete="off" value="<?php echo $kls ?>">
														    </div>
														</div>
								                        <div class="form-group">
								                            <label class="col-sm-3 control-label">Tahun Akademik</label>
								                            <div class="col-sm-5">
								                                <input type="text" name='tahun_akademik' class="form-control mask" data-inputmask="'mask':'9999/9999'" required="on" autofocus autocomplete="off" placeholder="20xx/20xx"  disabled="on" value="<?php echo $ta; ?>">
								                            </div>
								                        </div>
								                        <div class="form-group">
														    <label class="col-sm-3 control-label">Semester</label>
														    <div class="col-sm-5">
														        <input type="text" name='semester' class="form-control mask" data-inputmask="'mask':'9'" required="on"  autocomplete="off" placeholder="x" disabled="on" value="<?php echo $smt ?>">
														    </div>
														</div>
