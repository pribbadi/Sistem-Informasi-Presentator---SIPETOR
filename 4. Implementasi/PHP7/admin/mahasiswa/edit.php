...
<head>
    ...
    <title>
    	<?php 
    		...
    		$idd=$_GET['id'];
		    $mhs=mysqli_query($link, "select * from mahasiswa where id_mahasiswa='$idd'");
		    $res_mhs=mysqli_fetch_array($mhs);
												...
												<div class="panel-body no-padding">
													<form action="edit_proses.php?id=<?php echo $idd; ?>" class="form-horizontal row-border" method="POST">
								                        ...
								                        <div class="form-group">
														    ...
														    <div class="col-sm-5">
														        <input type="text" value="<?php echo $nama ?>" name='nama_baru' class="form-control" required="on" autofocus="on" autocomplete="off">
														    </div>
														</div>
														<div class="form-group">
														    <label class="col-sm-3 control-label">Password Lama</label>
														    <div class="col-sm-5">
														        <input type="password" name='password_lama' class="form-control"  autocomplete="off" placeholder="isi password jika ingin dirubah">
														    </div>
								                            <div class="col-sm-4"><p class="help-block">isi password jika ingin dirubah</p></div>
														</div>	
